...
namespace Uno.Physics.Box2D
{
    ...
    public class BodyDef
    {
        ...
        public BodyDef()
        {
            ...
            angle = 0.0f;
            linearVelocity = float2(0.0f, 0.0f);
    ...
    public class Body
    {
	    ...
	    public void DestroyFixture(Fixture fixture)
        {
	        ...
	        Fixture box2dNode = _fixtureList;
	        bool found = false;
	        while (box2dNode != null)
	        {
		        if (box2dNode == fixture)
		        {
        ...
        public void SetTransformIgnoreContacts(float2 position, float angle)
        {
	    ...
	    public void SetLinearVelocity(float2 v)
        {
            if (_type == BodyType.Static)
            {
                return;
        ...
        {
            return _I + _mass * Uno.Vector.Dot(_sweep.localCenter, _sweep.localCenter);
        }
	    ...
	    public void GetMassData(out MassData massData)
        {
            ...
            massData.mass = _mass;
            massData.I = _I + _mass * Uno.Vector.Dot(_sweep.localCenter, _sweep.localCenter);
        ...
        public void SetMassData(ref MassData massData)
        {
	        ...
	        {
		        _I = massData.I - _mass * Uno.Vector.Dot(massData.center, massData.center);

		        _invI = 1.0f / _I;
	        }

	        // Move center of mass.
	        float2 oldCenter = _sweep.c;
        ...
        public void ResetMassData()
        {
	        ...
	        if (_I > 0.0f && (_flags & BodyFlags.FixedRotation) == 0)
	        {
		        ...
		        _I -= _mass * Uno.Vector.Dot(center, center);
	    ...
	    public float2 GetWorldPoint(float2 localPoint)
        {
	    ...
	    public float2 GetLocalPoint(float2 worldPoint)
        {
	    ...
	    public float2 GetLinearVelocityFromWorldPoint(float2 worldPoint)
        {
	    ...
	    /// @return the world velocity of a point.
	    public float2 GetLinearVelocityFromLocalPoint(float2 localPoint)
        {
        ...
        internal float2 _linearVelocity;
        internal float _angularVelocity;

        internal float2 _force;
