...
namespace Uno.Physics.Box2D
{
    public class EdgeShape : Shape
    {
        ...
        {
            aabb = new AABB();
            float2 v1 = MathUtils.Multiply(ref transform, _vertex1);
            float2 v2 = MathUtils.Multiply(ref transform, _vertex2);

	        float2 lower = MathUtils.Min(v1, v2);
	        float2 upper = MathUtils.Max(v1, v2);
	    ...
	    public float2 _vertex1, _vertex2;

	    /// Optional adjacent vertices. These are used for smooth collision.
	    public float2 _vertex0, _vertex3;
