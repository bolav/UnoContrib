    ...
    public struct SeparationFunction
    {
            ...
            float t1)
	    {
		    ...
		    if (count == 1)
		    {
                ...
                float2 localPointA = _proxyA.GetVertex(cache.indexA[0]);
                float2 localPointB = _proxyB.GetVertex(cache.indexB[0]);
		    ...
		    else if (cache.indexA[0] == cache.indexA[1])
		    {
                ...
                float2 localPointB1 = proxyB.GetVertex(cache.indexB[0]);
                float2 localPointB2 = proxyB.GetVertex(cache.indexB[1]);
                ...
                float2 localPointA = proxyA.GetVertex(cache.indexA[0]);
                float2 pointA = MathUtils.Multiply(ref xfA, localPointA);

			    float s = Uno.Vector.Dot(pointA - pointB, normal);
			    if (s < 0.0f)
			    {
				    _axis = _axis * -1.0f;
                    s = -s;
		    ...
		    else
		    {
			    ...
			    float2 localPointA1 = _proxyA.GetVertex(cache.indexA[0]);
			    float2 localPointA2 = _proxyA.GetVertex(cache.indexA[1]);
			    ...
			    float s = Uno.Vector.Dot(pointB - pointA, normal);
			    if (s < 0.0f)
			    {
				    _axis = -_axis;
				    s = -s;
	    ...
	    public float FindMinSeparation(out int indexA, out int indexB, float t)
	    {
		    ...
		    switch (_type)
		    {
                case SeparationFunctionType.Points:
			    {
				    ...
				    float separation = Uno.Vector.Dot(pointB - pointA, _axis);
				    return separation;
			    }
                ...
                case SeparationFunctionType.FaceA:
			    {
				    ...
				    float separation = Uno.Vector.Dot(pointB - pointA, normal);
				    return separation;
			    }
		        ...
		        case SeparationFunctionType.FaceB:
			    {
				    ...
				    float separation = Uno.Vector.Dot(pointA - pointB, normal);
				    return separation;
			    }
    ...
    public static class TimeOfImpact
    {
        ...
        public static void CalculateTimeOfImpact(out TOIOutput output, ref TOIInput input)
        {
	        ...
	        for(;;)
	        {
                ...
                var fcn = new SeparationFunction(ref cache, ref input.proxyA, ref sweepA, ref input.proxyB, ref sweepB, t1);
