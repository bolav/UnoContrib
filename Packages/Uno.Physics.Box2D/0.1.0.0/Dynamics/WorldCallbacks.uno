...
namespace Uno.Physics.Box2D
{
    ...
    public delegate float RayCastCallback(Fixture fixture, float2 point, float2 normal, float fraction);
    ...
    public abstract class DebugDraw
    {
	    ...
	    public abstract void DrawPolygon(ref float2[] vertices, int count, float4 color, float2 center);

	    /// Draw a solid closed polygon provided in CCW order.
        public abstract void DrawSolidPolygon(ref float2[] vertices, int count, float4 color, float2 center);

	    /// Draw a circle.
        public abstract void DrawCircle(float2 center, float radius, float4 color);

	    /// Draw a solid circle.
        public abstract void DrawSolidCircle(float2 center, float radius, float2 axis, float4 color);

	    /// Draw a line segment.
        public abstract void DrawSegment(float2 p1, float2 p2, float4 color, float2 center);
